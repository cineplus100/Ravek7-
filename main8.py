...
GUILD_IDS = None  # se quiser registrar os comandos apenas em guilds específicas, coloque [ID1, ID2]
...
async def on_member_join(member: discord.Member):
    try:
        ...
        if canal and canal.permissions_for(member.guild.me).send_messages:
            await canal.send(f"👋 Bem-vindo ao clã RV7 seu porra, {member.mention}! Leia as regras e se apresente 😊")
...
# /desban
@bot.tree.command(name="desban", description="Des
